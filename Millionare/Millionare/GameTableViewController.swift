...
class GameTableViewController: UITableViewController {
    ...
    var test = Question(question: "Столица России?", answer: ["Москва", "Санкт-Петербург", "Казань", "Екатеринбург"], trueAnswer: "Москва")
    ...
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        ...
        if userAnswerTextField.text == test.trueAnswer {
